...
void ui_event_SplashScreen(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_SCREEN_LOADED) {
        _ui_screen_change(&ui_HomeScreen, LV_SCR_LOAD_ANIM_FADE_ON, 0, 2000, &ui_HomeScreen_screen_init);
    }
}
...
void ui_SplashScreen_screen_init(void)
{
    ...
    lv_obj_add_state(ui_SplashScreen, LV_STATE_USER_1 | LV_STATE_USER_2);       /// States
    ...
    lv_img_set_src(ui_Image1, &ui_img_logo_white_png);
